...
class DivisionsControllerTest < ActionController::TestCase
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post :create, division: { description: @division.description, gender: @division.gender, name: @division.name }
    end
  ...
  test "should update division" do
    patch :update, id: @division, division: { description: @division.description, gender: @division.gender, name: @division.name }
    assert_redirected_to division_path(assigns(:division))
  end
